...
import com.example.kakaoapisample.databinding.ActivityMainBinding
        ...
        RetrofitClient.kakaoLocalApiService.searchByKeyword(apiKey, keyword)
            .enqueue(object : Callback<SearchResponse> {
                override fun onResponse(call: Call<SearchResponse>, response: Response<SearchResponse>) {
                    if (response.isSuccessful) {
                        ...
                        if (!places.isNullOrEmpty()) {
                            ...
                            Toast.makeText(this@MainActivity, "총 ${places.size}개 장소 발견", Toast.LENGTH_SHORT).show()
                ...
                override fun onFailure(call: Call<SearchResponse>, t: Throwable) {
                    Toast.makeText(this@MainActivity, "API 호출 실패: ${t.message}", Toast.LENGTH_SHORT).show()
                }
            })
    }
